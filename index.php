...
<div class="container">
    <div class="imageupload panel panel-default">
        <div class="panel-heading clearfix">
            <h3 class="panel-title pull-left">Download Excel File</h3>
        </div>
        <div class="file-tab panel-body">
			<?php
			$filepath = 'Excel_Reader.xlsx';
			if ( file_exists( $filepath ) ) {
				?>
                <a href="controller/download.php"><button class="btn btn-primary">Download File</button> </a>
			<?php }else{?>
                <label class="btn btn-default btn-file">File Not Found</label>
			<?php } ?>
        </div>
    </div>
</div>
